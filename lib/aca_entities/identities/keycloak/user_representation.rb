...
module AcaEntities
  module Identities
    module Keycloak
      ...
      class UserRepresentation < Dry::Struct
        attribute :access, Types::Hash.optional.meta(omittable: true)
        attribute :attributes, Types::Hash.optional.meta(omittable: true)
        attribute :clientConsents, Types::Array.of(Types::String).optional.meta(omittable: true)
        ...
        attribute :credentials,
                  Types::Array
                    .of(AcaEntities::Identities::Keycloak::CredentialRepresentation)
                    .optional
                    .meta(omittable: true)
        attribute :disableableCredentialTypes, Types::Array.of(Types::String).optional.meta(omittable: true)
        ...
        attribute :federatedIdentities, Types::Array.of(Types::String).optional.meta(omittable: true)
        attribute :federationLink, Types::Array.of(Types::String).optional.meta(omittable: true)
        attribute :firstName, Types::String.optional.meta(omittable: true)
        attribute :groups, Types::Array.of(Types::String).optional.meta(omittable: true)
        ...
        attribute :realmRoles, Types::Array.of(Types::String).optional.meta(omittable: true)
        attribute :requiredActions, Types::Array.of(Types::String).optional.meta(omittable: true)
        attribute :self, Types::String.optional.meta(omittable: true)
        attribute :serviceAccountClientId, Types::String.optional.meta(omittable: true)
