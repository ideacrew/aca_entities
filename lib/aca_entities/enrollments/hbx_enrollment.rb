...
module AcaEntities
  module Enrollments
    class HbxEnrollment < Dry::Struct
      ...
      attribute :special_enrollment_period,                       AcaEntities::EnrollmentPeriod::SpecialEnrollmentPeriodReference.optional.meta(omittable: false)
      ...
      attribute :benefit_package,                                 AcaEntities::BenefitCatalogs::BenefitPackageReference.optional.meta(omittable: false)
      attribute :benefit_coverage_period,                         AcaEntities::BenefitCatalogs::BenefitCoveragePeriodReference.optional.meta(omittable: false)
      # shop attributes
