...
module AcaEntities
  module Accounts
    class User < Dry::Struct
      ...
      attribute :identity_final_decision_transaction_id,  Types::String.optional.meta(omittable: true)
      attribute :identity_response_code,                  Types::String.optional.meta(omittable: true)
      attribute :identity_response_description_text,      Types::String.optional.meta(omittable: true)
      attribute :identity_verified_date,                  Types::Date.optional.meta(omittable: true)
