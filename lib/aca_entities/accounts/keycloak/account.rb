  ...
  module Accounts
    module Keycloak
      ...
      class Account < Dry::Struct
        ...
        attribute :realm_roles, Types::Array.of(Types::String).optional.meta(omittable: true)
        attribute :client_roles, Types::Array.of(Types::String).optional.meta(omittable: true)
        ...
        # attribute :profiles, Types::Array.of(AcaEntities::Accounts::Profile).optional.meta(omittable: true)
