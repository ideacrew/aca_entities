...
module AcaEntities
  module InsurancePolicies
    module Contracts
      ...
      class PolicyPremiumAdjustmentContract < Contract
        # @!method call(opts)
        ...
        params do
          ...
          required(:policy_item_premium).value(
            AcaEntities::InsurancePolicies::Contracts::PolicyItemPremiumContract.params
          )
          required(:premium_schedule).value(AcaEntities::InsurancePolicies::Contracts::PremiumScheduleContract.params)
          optional(:discount_premium_adjustments).array(
            AcaEntities::InsurancePolicies::Contracts::AdjustmentTypeContract.params
          )
          optional(:surcharge_premium_adjustments).array(
            AcaEntities::InsurancePolicies::Contracts::AdjustmentTypeContract.params
          )
