    ...
    module Contacts
      ...
      class ContactContract < ApplicationContract
        ...
        params do
          ...
          optional(:emails).array(Crm::Types::Email)
          ...
          optional(:gender).maybe(Crm::Types::GenderKind)
          optional(:preferred_language).maybe(:string)
          optional(:used_interpreter).maybe(Crm::Types::YesNoUnknownKind)
        ...
        #     key.failure(text: "invalid account contact", error: result.errors.to_h) if result&.failure?
        #   end
        # end
        ...
        #     key.failure(text: "invalid index case opportunity", error: result.errors.to_h) if result&.failure?
        #   end
        # end
