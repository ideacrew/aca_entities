...
module Contacts
  ...
  class Contact < Dry::Struct
    ...
    attribute :gender,                    CovidMost::Types::GenderKind.optional.meta(omittable: true)
    attribute :preferred_language,        Types::String.optional.meta(omittable: true)
    attribute :used_interpreter,          CovidMost::Types::YesNoUnknownKind.optional.meta(omittable: true)
    ...
    attribute :alt_email,                 CovidMost::Types::Email.optional.meta(omittable: true)
    attribute :phone,                     CovidMost::Types::PhoneNumber.optional.meta(omittable: true)
    attribute :mobile,                    CovidMost::Types::PhoneNumber.optional.meta(omittable: true)
