        ...
        module Transforms
          module SmartyResponseTo
            ...
            class Address
              ...
              # @options params [Hash] response payload to be transformed
              # @return [String] Success: CV Address wrapped in Dry::Monads::Result
              # @return [String] Failure: CV Address wrapped in Dry::Monads::Result
              def call(params)
              ...
              def validate(params)
                ...
                result = AcaEntities::Locations::Smarty::Contracts::LookupContract.new.call(params)
