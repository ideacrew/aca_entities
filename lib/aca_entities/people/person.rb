...
module AcaEntities
  module People
    class Person < Dry::Struct
      ...
      attribute :no_dc_address_reason,                   Types::Bool.optional.meta(omittable: true)
      ...
      attribute :age_off_excluded,                       Types::Bool.meta(omittable: true)
      attribute :is_applying_for_assistance,             Types::Bool.meta(omittable: true)

      attribute :is_active,                              Types::String.optional.meta(omittable: true)
      attribute :is_disabled,                            Types::Bool.meta(omittable: true)

      attribute :person_relationships,                   Types::Array.of(AcaEntities::People::PersonRelationship).optional.meta(omittable: true)
      ...
      attribute :broker_role,                            Broker::BrokerRole.optional.meta(omittable: true)
