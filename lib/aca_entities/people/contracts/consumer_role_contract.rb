    ...
    module Contracts
      ...
      class ConsumerRoleContract < Dry::Validation::Contract
        ...
        params do
          ...
          optional(:ridp_documents).array(AcaEntities::Documents::Contracts::RidpDocumentContract.params)
          optional(:verification_type_history_elements).array(
            AcaEntities::Contracts::Verifications::VerificationTypeHistoryElementContract.params
          )
          optional(:lawful_presence_determination).hash(
            AcaEntities::Determinations::Contracts::LawfulPresenceDeterminationContract.params
          )
          optional(:local_residency_responses).array(AcaEntities::Events::Contracts::EventResponseContract.params)
          optional(:local_residency_requests).array(AcaEntities::Events::Contracts::EventRequestContract.params)
        end
      end
    end
  end
