...
module Medicaid
  module Transforms
    module McrTo
      class CvInput < ::Operations::Transform
          ...
          rewrap 'family' do
            ...
            namespace 'members.*', nil, context: {name: 'members'} do
              ...
              rewrap 'family.family_members', type: :array do
                ...
                map 'application.contactMemberIdentifier','is_primary_applicant', -> v { v.context(:primary_applicant_identifier).is_primary_applicant }
