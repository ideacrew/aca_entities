...
module AcaEntities
  module Medicaid
    module Atp
      # entity for atp RefugeeMedicalAssistanceBasis
      class RefugeeMedicalAssistanceBasis < Dry::Struct
        ...
        attribute :medical_assistance_end_date, Types::Date.optional.meta(omittable: true)
