  ...
  module Medicaid
    module Atp
      ...
      class Person < Dry::Struct
        ...
        # attribute :ethnicities, Types::Array.of(Types::Hash).optional.meta(omittable: true)
        attribute :ethnicities, Types::Array.of(PersonEthnicityText).optional.meta(omittable: true)
