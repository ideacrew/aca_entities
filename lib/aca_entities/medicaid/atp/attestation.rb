  ...
  module Medicaid
    module Atp
      ...
      class Attestation < Dry::Struct
        ...
        attribute :attested_not_incarcerated_indicator, Types::Bool.meta(omittable: false)
        attribute :pending_disposition, Types::String.optional.meta(omittable: true)
        attribute :attested_if_information_changes_indicator, Types::Bool.meta(omittable: false)
        attribute :attested_medicaid_applicant_awareness_indicator, Types::Bool.optional.meta(omittable: true)
        attribute :attested_non_perjury_indicator, Types::Bool.meta(omittable: false)
        ...
        attribute :coverage_renewal_year_qty, Types::Integer.optional.meta(omittable: true)
      end
    end
  end
end
