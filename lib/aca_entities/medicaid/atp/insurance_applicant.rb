  ...
  module Medicaid
    module Atp
      ...
      class InsuranceApplicant < Dry::Struct
        ...
        attribute :student_indicator, Types::Bool.optional.meta(omittable: true)
        attribute :eligible_itu_services_indicator, Types::Bool.optional.meta(omittable: true)
        attribute :received_itu_services_indicator, Types::Bool.optional.meta(omittable: true)
        attribute :recent_medical_bills_indicator, Types::Bool.optional.meta(omittable: true)
