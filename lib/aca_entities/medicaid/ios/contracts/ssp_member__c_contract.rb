      ...
      module Contracts
        ...
        class SspMemberCContract < Dry::Validation::Contract
          params do
            ...
            optional(:DivorceDate__c).maybe(:string)
            ...
            optional(:ImmigrationStatus__c).maybe(:string)
            ...
            optional(:IsDeleted__c).maybe(:string)
            optional(:IsDisabledToggle__c).maybe(:string)
            optional(:IsEligibleForIHFlagToggle__c).maybe(:string)
            ...
            optional(:TribeName__c).maybe(:string)
