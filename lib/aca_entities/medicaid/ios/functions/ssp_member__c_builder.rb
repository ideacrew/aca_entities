        ...
        class SspMemberCBuilder
          ...
          def call(cache)
            ...
            applicants.map do |applicant|
              ...
              vlp_document = applicant.dig(:vlp_document)
              ...
              member_hash = {
                ...
                'IsUSCitizenToggle__c' => boolean_string(applicant&.dig(:citizenship_immigration_status_information, :citizen_status) == "us_citizen"),
