          ...
          def call(cache)
            ...
            applicants.map do |applicant|
...

              {
                ...
                'IsDeleted__c' => boolean_string(applicant&.dig(:incomes)&.detect { |x| x[:kind] == 'wages_and_salaries' }&.dig(:end_on)),
                ...
                'IsReceivingMedicareBenefitToggle__c' => boolean_string(applicant&.dig(:benefits)&.detect { |x| x[:kind] == 'medicare' }&.present?),
