  ...
  module Families
    class Family < Dry::Struct
      ...
      attribute :applications,
                Types::Strict::Array.of(AcaEntities::MagiMedicaid::ApplicationReference).optional.meta(omittable: true)
      ...
      attribute :special_enrollment_periods,
                Types::Strict::Array.of(AcaEntities::EnrollmentPeriods::SpecialEnrollmentPeriod).optional.meta(omittable: true)
      ...
      attribute :general_agency_accounts,
                Types::Strict::Array.of(AcaEntities::GeneralAgencies::GeneralAgencyAccount).optional.meta(omittable: true)
      ...
      attribute :payment_transactions,
                Types::Strict::Array.of(AcaEntities::Financial::PaymentTransactions::PaymentTransaction).optional.meta(omittable: true)
