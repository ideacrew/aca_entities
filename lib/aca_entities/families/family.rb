...
module AcaEntities
  module Families
    ...
    class Family < Dry::Struct
      ...
      # @return [Array<Household>]
      attribute :tax_household_groups,              Types::Array.of(AcaEntities::Households::TaxHouseholdGroup).optional.meta(omittable: true)
      ...
      attribute :eligibility_determination,         AcaEntities::Eligibilities::Determination.optional.meta(omittable: false)
