...
module AcaEntities
  module Organizations
    module Contracts
      ...
      #   end
      class TenantContract < AcaEntities::Organizations::Contracts::Contract
        #   params do
        ...
        #   #       valid_environment_keys = %i[production development test]
        ...
        #   #             .errors
        #   #             .messages
        #   #             .reduce([]) do |list, message|
        #   #               list << {
        #   #                 features: [
        #   #                   { path: message.path },
        #   #                   { input: message.input.to_s },
        ...
        #   #           result =
        #   #             AcaEntities::Enterprises::Contract::OptionContract.call(
        #   #               option
        #   #             )
        #   #           next unless result && result.failure?
        #   #           validation_errors << result
        ...
        #   #       else
        #   #         validation_errors << {
        #   #           environments: "invalid key: #{environment[:key]}"
        #   #         }
        #   #       end
        #   #     end
        #   #   end
