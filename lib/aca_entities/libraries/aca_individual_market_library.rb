...
module AcaEntities
  module Libraries
    module IndividualMarketLibrary
      ...
      require 'aca_entities/contracts/determinations/eligibility_determination_reference_contract'
      ...
      require 'aca_entities/determinations/eligibility_determination_reference'
