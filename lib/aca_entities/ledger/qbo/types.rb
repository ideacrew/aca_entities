  ...
  module Ledger
    module Qbo
      ...
      module Types
        ...
        AssetAccountBankKind = Types::Coercible::String.default('CashOnHand').enum(
          'CashOnHand',
          'Checking',
          'MoneyMarket',
          'RentsHeldInTrust',
        ...
        ExpenseAccountOtherExpenseKind = Types::Coercible::String.default('EmployeeCashAdvances').enum('EmployeeCashAdvances')
        ExpenseAccountCogsKind = Types::Coercible::String.default('EmployeeCashAdvances').enum('EmployeeCashAdvances')

        LiabilityAccountAccountsPayableKind = Types::Coercible::String.default('EmployeeCashAdvances').enum('EmployeeCashAdvances')
        LiabilityAccountCreditCardKind = Types::Coercible::String.default('EmployeeCashAdvances').enum('EmployeeCashAdvances')
        LiabilityAccountLongTermLiabilityKind = Types::Coercible::String.default('EmployeeCashAdvances').enum('EmployeeCashAdvances')
        LiabilityAccountOtherCurrentLiabilityKind = Types::Coercible::String.default('EmployeeCashAdvances').enum('EmployeeCashAdvances')

        RevenueAccountIncomeKind = Types::Coercible::String.default('EmployeeCashAdvances').enum('EmployeeCashAdvances')
        RevenueAccountOtherIncomeKind = Types::Coercible::String.default('EmployeeCashAdvances').enum('EmployeeCashAdvances')
