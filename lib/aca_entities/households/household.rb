...
module AcaEntities
  module Households
    class Household < Dry::Struct
      ...
      attribute :is_active,               Types::Integer.meta(omittable: false)
      ...
      attribute :coverage_households,     Types::Strict::Array.of(AcaEntities::Households::CoverageHousehold).meta(omittable: true)
