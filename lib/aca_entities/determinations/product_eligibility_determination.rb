...
module AcaEntities
  module Determinations
    class ProductEligibilityDetermination < Dry::Struct
      ...
      attribute :magi_medicaid_monthly_household_income,  AcaEntities::Curreny.optional.meta(omittable: false)
      attribute :medicaid_household_size,                 Types::Integer.optional.meta(omittable: true)
      attribute :magi_medicaid_monthly_income_limit,      AcaEntities::Curreny.optional.meta(omittable: false)
