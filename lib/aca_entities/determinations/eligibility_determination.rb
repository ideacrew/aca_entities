...
module AcaEntities
  module Determinations
    class EligibilityDetermination < Dry::Struct
      ...
      attribute :aptc_csr_annual_household_income,    AcaEntities::Currency.meta(omittable: false)
      attribute :aptc_annual_income_limit,            AcaEntities::Currency.meta(omittable: false)
      attribute :csr_annual_income_limit,             AcaEntities::Currency.meta(omittable: false)
