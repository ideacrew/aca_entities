  ...
  module Determinations
    module Contracts
      ...
      class LawfulPresenceDeterminationContract < Dry::Validation::Contract
        ...
        params do
          optional(:vlp_verified_at).maybe(:date_time)
          ...
          optional(:ssa_responses).array(AcaEntities::Events::Contracts::EventResponseContract.params)
          optional(:ssa_requests).array(AcaEntities::Events::Contracts::EventRequestContract.params)
          optional(:vlp_responses).array(AcaEntities::Events::Contracts::EventResponseContract.params)
          optional(:vlp_requests).array(AcaEntities::Events::Contracts::EventRequestContract.params)
        end
      end
    end
  end
