  ...
  module Fdsh
    module Ifsv
      ...
      module H9t
        ...
        # fti_taxable_social_security_benefits_amount
        # Identifies the amount of taxable Social Security benefits included in the individual's Tax Return Income Amount
        ...
        # fti_individual_response_code # IRS returns code(s) when a specific account condition exists
        # and/or when certain information is not available for an individual
        # fti_individual_reponse_description_text #IRS returns description(s) to explain an account condition
        # or to identify why certain information is not available for an individual
