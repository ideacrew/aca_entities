    ...
    module Ssa
      module H3
        ...
        class SSATitleIIMonthlyIncome < Dry::Struct
          ...
          attribute :OngoingMonthlyBenefitCreditedAmount,  Types::Float.optional.meta(omittable: true)
          attribute :OngoingMonthlyOverpaymentDeductionAmount,  Types::Float.optional.meta(omittable: true)
