...
module AcaEntities
  module Enrollees
    ...
    class Enrollee < Dry::Struct
      attribute :enrollee_demographics, AcaEntities::Enrollees::EnrolleeDemographics.meta(omittable: false)
      ...
      attribute :segments, Types::Array.of(AcaEntities::Enrollees::Segment).optional.meta(omittable: true)
      ...
      def mailing_address
        ...
        addresses.detect { |address| address.kind == 'mailing' }
      end
