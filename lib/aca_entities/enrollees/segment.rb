...
module AcaEntities
  module Enrollees
    ...
    class Segment < Dry::Struct
      ...
      attribute :individual_premium_amount,    Types::Decimal.optional.meta(omittable: true)
      attribute :individual_responsible_amount,  Types::Decimal.optional.meta(omittable: true)
      attribute :total_premiumum_amount,    Types::Decimal.optional.meta(omittable: true)
      attribute :total_responsible_amount,  Types::Decimal.optional.meta(omittable: true)
