...
module AcaEntities
  module Enrollees
    ...
    class Segment < Dry::Struct
      ...
      attribute :effective_start_date,    Types::String.meta(omittable: false)
      attribute :effective_end_date,    Types::String.meta(omittable: false)
      ...
      attribute :partial_month_start_date,    Types::String.optional.meta(omittable: true)
      attribute :partial_month_end_date,    Types::String.optional.meta(omittable: true)
    end
  end
end
