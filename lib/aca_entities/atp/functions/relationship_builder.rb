      ...
      class RelationshipBuilder
        ...
        def person_hash
          { hbx_id: '1234', # default value
            first_name: @memoized_data.find(Regexp.new("person_name.first_name.#{@primary_applicant_id}"))&.first&.item&.downcase&.capitalize,
            last_name: @memoized_data.find(Regexp.new("person_name.last_name.#{@primary_applicant_id}"))&.first&.item&.downcase&.capitalize,
