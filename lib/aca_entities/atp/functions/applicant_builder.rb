      ...
      class ApplicantBuilder
        def call(cache)
          ...
          applicants_hash.each_with_object([]) do |applicant_hash, collector|
            ...
            non_esi_coverage_indicators = non_esi_coverage_indicators(non_esi_coverage_enrolled_array)
            non_esi_policies = get_non_esi_policies(non_esi_coverage_eligible_array)
        ...
        def non_esi_coverage_indicators(non_esi_coverage_enrolled_array)
        ...
        def get_non_esi_policies(non_esi_coverage_eligible_array)
