      ...
      module Contracts
        ...
        class PersonContract < Dry::Validation::Contract
          ...
          params do
            ...
            optional(:is_self_attested_long_term_care).maybe(Types::YesNoKind)
            ...
            optional(:is_lawful_presence_self_attested).maybe(Types::YesNoKind)
