...
module AcaEntities
  module MagiMedicaid
    ...
    class CategoryDetermination < Dry::Struct
      ...
      attribute :category, ::AcaEntities::MagiMedicaid::Mitc::Types::CategoryDeterminationKind.meta(ommittable: false)
      ...
      attribute :indicator_code, Types::Bool.optional.meta(ommittable: false)
