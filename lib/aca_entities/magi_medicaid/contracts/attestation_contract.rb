  ...
  module MagiMedicaid
    module Contracts
      ...
      class AttestationContract < Dry::Validation::Contract
        ...
        # @option opts [Boolean] :is_self_attested_disabled optional
        # @option opts [Boolean] :is_self_attested_blind optional
        # @option opts [Boolean] :is_self_attested_long_term_care optional
        # @return [Dry::Monads::Result]
        params do
          optional(:is_incarcerated).maybe(:bool)
          optional(:is_self_attested_disabled).maybe(:bool)
          optional(:is_self_attested_blind).maybe(:bool)
