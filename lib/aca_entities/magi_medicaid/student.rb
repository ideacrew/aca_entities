...
module AcaEntities
  module MagiMedicaid
    ...
    class Student < Dry::Struct
      ...
      attribute :student_kind, Types::StudentKind.optional.meta(omittable: true)
      attribute :student_school_kind, Types::StudentSchoolKind.optional.meta(omittable: true)
