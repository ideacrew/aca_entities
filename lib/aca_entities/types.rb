...
module AcaEntities
  ...
  module Types
    ...
    UriKind = Types.Instance(URI::Generic) | Types.Constructor(String) { |value| URI(value.to_s) }
  ...
  # DEPRECATED - {Types::RelayStateKinds} is deprecated.  Please use {AcaEntities::Types::RelayStateKind} instead
  RelayStateKinds =
    Types::Coercible::String.enum(
      '/exchanges/hbx_profiles',
      '/benefit_sponsors/profiles/registrations/new?portal=true&profile_type=broker_agency',
  ...
  # DEPRECATED - {Types::UriKind} is deprecated.  Please use {AcaEntities::Types::UriKind} instead
  UriKind = Types.Instance(URI::Generic) | Types.Constructor(String) { |value| URI(value.to_s) }
