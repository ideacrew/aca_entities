...
module AcaEntities
  ...
  module Types
    ...
    ClassOfAdmissionCode = Types::Coercible::String.enum(
      'IR1',
      'IR6',
      'CR1',
      'CR6',
    ...
    IsoAlpha3Code = Types::Coercible::String.enum(
      'ABW',
      'AFG',
      'AGO',
      'AIA',
    ...
    ImmigrationDocumentTypeCode = Types::Coercible::String.enum(
      'AmericanSamoan',
    ...
    IndianTribeStateCode = Types::Coercible::String.enum(
      'Alabama',
      'Alaska',
      'Arizona',
      'California',
    ...
    CoverageTypeCode = Types::Coercible::String.enum(
      'CHIP',
      'EmergencyMedicaid',
    ...
    MetalLevelCode = Types::Coercible::String.enum(
      'Platinum',
      'Gold',
      'Silver',
      'Bronze',
    ...
    RelationshipToTaxFilerCode = Types::Coercible::String.enum(
      "01",
      "03",
      "04",
      "05",
    ...
    AttestedChildOfCaretakerCode = Types::Coercible::String.enum(
      'YesCovered',
      'YesNotCovered',
      'No'
    )

    AbsentParentCode = Types::Coercible::String.enum(
      'Yes',
      'No',
      'Yes-Exempt'
    )
