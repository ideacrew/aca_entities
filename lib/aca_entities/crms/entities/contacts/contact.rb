  ...
  module Crms
    module Contacts
      class Contact < Dry::Struct
        ...
        attribute :contact_index_cases,
                  Types::Array
                    .of(Contacts::ContactIndexCase)
                    .optional
                    .meta(omittable: true)
        attribute :contact_exposure_cases,
                  Types::Array
                    .of(Contacts::ContactExposureCase)
                    .optional
                    .meta(omittable: true)
        attribute :absences,
                  Types::Array
        ...
        attribute :contact_opportunities,
                  Types::Array
                    .of(Opportunities::Opportunity)
                    .meta(omittable: true)
        ...
        attribute :gender,
                  CovidMost::Types::GenderKind.optional.meta(omittable: true)
        attribute :preferred_language,
                  Types::String.optional.meta(omittable: true)
        attribute :used_interpreter,
                  CovidMost::Types::YesNoUnknownKind.optional.meta(
                    omittable: true
                  )
        ...
        attribute :email, CovidMost::Types::Email.optional.meta(omittable: true)
        attribute :alt_email,
                  CovidMost::Types::Email.optional.meta(omittable: true)
        attribute :phone,
                  CovidMost::Types::PhoneNumber.optional.meta(omittable: true)
        attribute :mobile,
                  CovidMost::Types::PhoneNumber.optional.meta(omittable: true)
