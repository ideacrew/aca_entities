      ...
      module Medicaid
        module Atp
          ...
          class InsuranceApplicant
            ...
            element :temporarily_lives_outside_application_state_indicator, Boolean, tag: 'InsuranceApplicantTemporarilyLivesOutsideApplicationStateIndicator'
            ...
            #True if claiming tax filer is a non-custodial parent and if the claiming tax filer can be considered a caretaker relative; false otherwise.
