        ...
        module Atp
          ...
          class FullTelephone
            ...
            def self.domain_to_mapper(telephone)
              mapper = self.new
              mapper.telephone_number_full_id = telephone.telephone_number_full_id unless telephone.telephone_number_full_id.empty?
              mapper.telephone_suffix_id = telephone.telephone_suffix_id unless telephone.telephone_suffix_id.empty?
              mapper
            end
