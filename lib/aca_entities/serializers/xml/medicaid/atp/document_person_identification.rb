    ...
    module Xml
      module Medicaid
        module Atp
          ...
          class DocumentPersonIdentification
            include HappyMapper

            tag 'LawfulPresenceDocumentPersonIdentification'
            namespace 'hix-ee'
            ...
            def self.domain_to_mapper(identification)
              ...
              mapper.identification_jurisdiction = identification.identification_jurisdiction
              mapper
            end
