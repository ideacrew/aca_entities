...
module AcaEntities
  module Serializers
    module Xml
      module Medicaid
        module Atp
          # A basis for Medicaid MAGI (Modified Adjusted Gross Income) eligibility based on Child category rules
          class MedicaidMagiChildCategoryEligibilityBasis
            include HappyMapper

            tag 'MedicaidMAGIChildCategoryEligibilityBasis'
            namespace 'hix-ee'
