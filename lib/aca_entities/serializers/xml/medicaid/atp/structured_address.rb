      ...
      module Medicaid
        module Atp
          ...
          class StructuredAddress
            ...
            def self.domain_to_mapper(sa)
              mapper = self.new
              mapper.location_street = LocationStreet.domain_to_mapper(sa.location_street)
              mapper.address_secondary_unit_text = sa.address_secondary_unit_text
              mapper.location_city_name = sa.location_city_name
              mapper.location_county_name = sa.location_county_name
              mapper.location_county_code = sa.location_county_code
              mapper.location_state_us_postal_service_code = sa.location_state_us_postal_service_code
              mapper.location_postal_code = sa.location_postal_code
              mapper
            end
