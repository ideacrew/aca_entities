        ...
        module Atp
          ...
          class StructuredAddress
            ...
            def self.domain_to_mapper(structured_address)
              ...
              mapper.location_county_name = structured_address&.location_county_name if structured_address&.location_county_name && !structured_address.location_county_name.empty?
