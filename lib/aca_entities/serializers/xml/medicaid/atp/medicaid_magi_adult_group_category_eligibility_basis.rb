...
module AcaEntities
  module Serializers
    module Xml
      module Medicaid
        module Atp
          # A basis for Medicaid MAGI (Modified Adjusted Gross Income) eligibility based on adult group category rules.
          class MedicaidMagiAdultGroupCategoryEligibilityBasis
            include HappyMapper

            tag 'MedicaidMAGIAdultGroupCategoryEligibilityBasis'
            namespace 'hix-ee'
