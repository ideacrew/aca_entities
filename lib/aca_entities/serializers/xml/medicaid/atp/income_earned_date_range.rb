        ...
        module Atp
          ...
          class IncomeEarnedDateRange
            ...
            def self.domain_to_mapper(income_earned_date_range)
              mapper = self.new
              mapper.start_date = StartDate.domain_to_mapper(income_earned_date_range.start_date) if income_earned_date_range.start_date&.date
              mapper.end_date = EndDate.domain_to_mapper(income_earned_date_range.end_date) if income_earned_date_range.end_date&.date
              mapper
            end
