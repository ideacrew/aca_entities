      ...
      module Medicaid
        module Atp
          ...
          class MedicaidHousehold
            ...
            #True if a household's income is greater than the highest applicable Modified Adjusted Gross Income (MAGI) standard for the household size; false otherwise
            element :income_above_highest_applicable_magi_standard_indicator, Boolean, tag: 'MedicaidHouseholdIncomeAboveHighestApplicableMAGIStandardIndicator'
