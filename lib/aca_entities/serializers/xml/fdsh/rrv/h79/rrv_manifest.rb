...
# operations
require_relative 'operations/rrv_manifest_request_to_xml'
require_relative 'operations/validate_rrv_manifest_request_payload_xml'
require_relative 'operations/validate_rrv_manifest_response_payload_xml'
