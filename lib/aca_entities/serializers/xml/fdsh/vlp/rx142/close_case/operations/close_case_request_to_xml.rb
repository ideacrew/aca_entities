                ...
                class CloseCaseRequestToXml
                  ...
                  def convert_to_xml(close_case_request)
                    encode_result = Try do
                      ::AcaEntities::Serializers::Xml::Fdsh::Vlp::Rx142::CloseCase::CloseCaseRequest.domain_to_mapper(close_case_request).to_xml
                    end
                  ...
                  def validate_xml(xml)
                    ValidateVlpRx142CloseCasePayloadXml.new.call(xml)
                  end
                end
              end
            end
