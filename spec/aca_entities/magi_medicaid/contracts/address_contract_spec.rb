...
RSpec.describe AcaEntities::MagiMedicaid::Contracts::AddressContract,  dbclean: :after_each do
  subject do
  ...
  describe "missing city field" do
    let(:params) do
      { kind: 'test', address_1: '1234', address_2: '1234', address_3: 'person', county: '', state: 'DC', zip: '12345', county_name: '' }
    end
  ...
  describe "passing empty address_1, city, kind, state, zip" do
    let(:params) do
      { kind: 'test', address_1: '', address_2: '1234', address_3: 'person', city: '', state: '', zip: '', county: '', county_name: '' }
    end
