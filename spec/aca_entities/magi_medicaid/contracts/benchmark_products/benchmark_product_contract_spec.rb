...
RSpec.describe ::AcaEntities::MagiMedicaid::Contracts::BenchmarkProducts::BenchmarkProductContract,  dbclean: :after_each do
  ...
  describe '#call' do
    ...
    context 'with invalid input_params' do
      ...
      it 'should return failure moand with error keys' do
        ...
        expect(subject.errors.to_h.keys).to eq([:effective_date,
                                                :primary_rating_address,
                                                :exchange_provided_code,
                                                :household_group_ehb_premium,
                                                :households])
      end
    end
  end
