...
require 'aca_entities/medicaid/mitc/eligibility_response'

RSpec.describe ::AcaEntities::Medicaid::Mitc::EligibilityResponse do
  describe 'with valid arguments' do
    ...
    it 'should initialize' do
      expect(described_class.new(input_params)).to be_a ::AcaEntities::Medicaid::Mitc::EligibilityResponse
    end
