...
require 'aca_entities/medicaid/mitc/contracts/medicaid_household_contract'

RSpec.describe ::AcaEntities::Medicaid::Mitc::Contracts::MedicaidHouseholdContract do
