...
require 'spec_helper'
require 'aca_entities/medicaid/atp/emergency_medicaid_residency_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::EmergencyMedicaidResidencyBasis,  dbclean: :around_each do
