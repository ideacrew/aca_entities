...
require 'spec_helper'
require 'aca_entities/medicaid/atp/chip_trafficking_victim_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipTraffickingVictimBasis,  dbclean: :around_each do
