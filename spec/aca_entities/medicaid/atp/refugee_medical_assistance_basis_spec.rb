...
require 'spec_helper'
require 'aca_entities/medicaid/atp/refugee_medical_assistance_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::RefugeeMedicalAssistanceBasis,  dbclean: :around_each do
