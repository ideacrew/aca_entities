...
require 'aca_entities/medicaid/atp/medicaid_magi_citizen_or_immigrant_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiCitizenOrImmigrantEligibilityBasis, dbclean: :around_each do
