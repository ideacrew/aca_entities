...
require 'spec_helper'
require 'aca_entities/medicaid/atp/chip_unborn_child_category_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipUnbornChildCategoryBasis,  dbclean: :around_each do
