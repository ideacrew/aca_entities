...
require 'spec_helper'
require 'aca_entities/medicaid/atp/exchange_incarceration_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ExchangeIncarcerationBasis,  dbclean: :around_each do
