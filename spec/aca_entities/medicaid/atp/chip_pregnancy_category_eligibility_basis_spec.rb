...
require 'aca_entities/medicaid/atp/chip_pregnancy_category_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipPregnancyCategoryEligibilityBasis,  dbclean: :around_each do
