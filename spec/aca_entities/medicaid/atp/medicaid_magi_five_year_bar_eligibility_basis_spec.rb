...
require 'aca_entities/medicaid/atp/medicaid_magi_five_year_bar_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiFiveYearBarEligibilityBasis,  dbclean: :around_each do
