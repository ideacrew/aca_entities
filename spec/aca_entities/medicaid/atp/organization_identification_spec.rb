...
require 'spec_helper'
require 'aca_entities/medicaid/atp/organization_identification'

RSpec.describe ::AcaEntities::Medicaid::Atp::OrganizationIdentification,  dbclean: :around_each do
