...
require 'aca_entities/medicaid/atp/emergency_medicaid_citizenship_and_immigration_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::EmergencyMedicaidCitizenshipAndImmigrationEligibilityBasis, dbclean: :around_each do
