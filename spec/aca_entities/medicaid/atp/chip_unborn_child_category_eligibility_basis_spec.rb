...
require 'aca_entities/medicaid/atp/chip_unborn_child_category_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipUnbornChildCategoryEligibilityBasis,  dbclean: :around_each do
