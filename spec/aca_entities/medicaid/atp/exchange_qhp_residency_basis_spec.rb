...
require 'spec_helper'
require 'aca_entities/medicaid/atp/exchange_qhp_residency_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ExchangeQhpResidencyBasis,  dbclean: :around_each do
