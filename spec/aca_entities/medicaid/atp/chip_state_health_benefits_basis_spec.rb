...
require 'spec_helper'
require 'aca_entities/medicaid/atp/chip_state_health_benefits_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipStateHealthBenefitsBasis,  dbclean: :around_each do
