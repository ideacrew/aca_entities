...
require 'aca_entities/medicaid/atp/emergency_medicaid_residency_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::EmergencyMedicaidResidencyEligibilityBasis,  dbclean: :around_each do
