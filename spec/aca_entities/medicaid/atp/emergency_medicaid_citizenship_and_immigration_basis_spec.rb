...
require 'spec_helper'
require 'aca_entities/medicaid/atp/emergency_medicaid_citizenship_and_immigration_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::EmergencyMedicaidCitizenshipAndImmigrationBasis,
