...
require 'aca_entities/medicaid/atp/chip_waiting_period_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipWaitingPeriodEligibilityBasis,  dbclean: :around_each do
