...
require 'aca_entities/medicaid/atp/medicaid_magi_adult_group_xx_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiAdultGroupXxEligibilityBasis,  dbclean: :around_each do
