...
require 'aca_entities/medicaid/atp/chip_medicaid_residency_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipMedicaidResidencyEligibilityBasis,  dbclean: :around_each do
