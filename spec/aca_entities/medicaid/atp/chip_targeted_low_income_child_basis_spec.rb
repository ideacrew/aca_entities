...
require 'spec_helper'
require 'aca_entities/medicaid/atp/chip_targeted_low_income_child_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipTargetedLowIncomeChildBasis,  dbclean: :around_each do
