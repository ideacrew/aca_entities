...
require 'aca_entities/medicaid/atp/chip_trafficking_victim_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipTraffickingVictimEligibilityBasis,  dbclean: :around_each do
