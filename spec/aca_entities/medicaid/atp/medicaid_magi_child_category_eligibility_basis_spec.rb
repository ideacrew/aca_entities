...
require 'aca_entities/medicaid/atp/medicaid_magi_child_category_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiChildCategoryEligibilityBasis,  dbclean: :around_each do
