...
require 'aca_entities/medicaid/atp/medicaid_magi_ssn_validation_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiSsnValidationEligibilityBasis, dbclean: :around_each do
