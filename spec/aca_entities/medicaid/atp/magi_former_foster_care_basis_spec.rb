...
require 'spec_helper'
require 'aca_entities/medicaid/atp/magi_former_foster_care_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MagiFormerFosterCareBasis,  dbclean: :around_each do
