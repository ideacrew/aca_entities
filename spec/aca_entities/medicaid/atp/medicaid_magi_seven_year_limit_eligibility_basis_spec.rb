...
require 'aca_entities/medicaid/atp/medicaid_magi_seven_year_limit_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiSevenYearLimitEligibilityBasis, dbclean: :around_each do
