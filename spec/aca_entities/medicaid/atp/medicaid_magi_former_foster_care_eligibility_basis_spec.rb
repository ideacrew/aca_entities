...
require 'aca_entities/medicaid/atp/medicaid_magi_former_foster_care_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiFormerFosterCareEligibilityBasis,  dbclean: :around_each do
