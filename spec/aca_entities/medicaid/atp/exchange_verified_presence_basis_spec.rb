...
require 'spec_helper'
require 'aca_entities/medicaid/atp/exchange_verified_presence_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ExchangeVerifiedPresenceBasis,  dbclean: :around_each do
