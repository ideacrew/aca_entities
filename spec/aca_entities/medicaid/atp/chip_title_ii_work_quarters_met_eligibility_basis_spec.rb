...
require 'aca_entities/medicaid/atp/chip_title_ii_work_quarters_met_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipTitleIiWorkQuartersMetEligibilityBasis,  dbclean: :around_each do
