...
require 'aca_entities/medicaid/atp/exchange_qhp_residency_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ExchangeQhpResidencyEligibilityBasis,  dbclean: :around_each do
