...
require 'aca_entities/medicaid/atp/insurance_applicant_esi_planned_coverage_date_range'

RSpec.describe ::AcaEntities::Medicaid::Atp::InsuranceApplicantEsiPlannedCoverageDateRange,  dbclean: :around_each do
