...
require 'aca_entities/medicaid/atp/medicaid_magi_parent_caretaker_category_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiParentCaretakerCategoryEligibilityBasis,  dbclean: :around_each do
