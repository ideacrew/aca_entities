...
require 'aca_entities/medicaid/atp/medicaid_magi_chipra214_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiChipra214EligibilityBasis,  dbclean: :around_each do
