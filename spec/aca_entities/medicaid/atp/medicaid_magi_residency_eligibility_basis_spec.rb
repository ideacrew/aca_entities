...
require 'aca_entities/medicaid/atp/medicaid_magi_residency_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiResidencyEligibilityBasis, dbclean: :around_each do
