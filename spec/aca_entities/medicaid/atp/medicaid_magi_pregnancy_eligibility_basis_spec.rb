...
require 'aca_entities/medicaid/atp/medicaid_magi_pregnancy_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiPregnancyEligibilityBasis,  dbclean: :around_each do
