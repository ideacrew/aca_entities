...
require 'aca_entities/medicaid/atp/exchange_verified_presence_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ExchangeVerifiedPresenceEligibilityBasis,  dbclean: :around_each do
