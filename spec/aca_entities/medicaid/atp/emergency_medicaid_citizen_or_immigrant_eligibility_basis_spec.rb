...
require 'aca_entities/medicaid/atp/emergency_medicaid_citizen_or_immigrant_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::EmergencyMedicaidCitizenOrImmigrantEligibilityBasis, dbclean: :around_each do
