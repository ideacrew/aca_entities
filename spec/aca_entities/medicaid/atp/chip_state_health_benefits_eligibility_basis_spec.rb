...
require 'aca_entities/medicaid/atp/chip_state_health_benefits_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipStateHealthBenefitsEligibilityBasis,  dbclean: :around_each do
