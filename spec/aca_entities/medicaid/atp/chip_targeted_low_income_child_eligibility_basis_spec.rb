...
require 'aca_entities/medicaid/atp/chip_targeted_low_income_child_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::ChipTargetedLowIncomeChildEligibilityBasis,  dbclean: :around_each do
