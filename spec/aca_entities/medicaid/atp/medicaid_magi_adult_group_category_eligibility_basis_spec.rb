...
require 'aca_entities/medicaid/atp/medicaid_magi_adult_group_category_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiAdultGroupCategoryEligibilityBasis,  dbclean: :around_each do
