...
require 'aca_entities/medicaid/atp/medicaid_magi_household_size_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiHouseholdSizeEligibilityBasis,  dbclean: :around_each do
