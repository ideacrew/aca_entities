...
require 'aca_entities/medicaid/atp/medicaid_magi_dependent_child_eligibility_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MedicaidMagiDependentChildEligibilityBasis, dbclean: :around_each do
