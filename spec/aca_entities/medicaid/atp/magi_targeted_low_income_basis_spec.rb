...
require 'spec_helper'
require 'aca_entities/medicaid/atp/magi_targeted_low_income_basis'

RSpec.describe ::AcaEntities::Medicaid::Atp::MagiTargetedLowIncomeBasis, dbclean: :around_each do
