...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_trafficking_victim_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipTraffickingVictimBasisContract,  dbclean: :around_each do
