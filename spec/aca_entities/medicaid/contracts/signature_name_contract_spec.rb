...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/signature_name_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::SignatureNameContract, dbclean: :after_each do
