...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_citizenship_and_immigration_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiCitizenshipAndImmigrationBasisContract,
