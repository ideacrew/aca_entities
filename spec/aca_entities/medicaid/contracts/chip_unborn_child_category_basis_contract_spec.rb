...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_unborn_child_category_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipUnbornChildCategoryBasisContract,  dbclean: :around_each do
