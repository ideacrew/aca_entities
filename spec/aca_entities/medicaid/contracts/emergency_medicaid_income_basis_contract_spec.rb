...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/emergency_medicaid_income_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::EmergencyMedicaidIncomeBasisContract,  dbclean: :around_each do
