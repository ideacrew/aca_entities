...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_adult_group_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiAdultGroupBasisContract,  dbclean: :around_each do
