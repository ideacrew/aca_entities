...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/refugee_medical_assistance_eligibility_header_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::RefugeeMedicalAssistanceEligibilityHeaderContract,
