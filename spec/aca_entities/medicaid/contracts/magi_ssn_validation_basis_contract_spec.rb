...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_ssn_validation_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiSsnValidationBasisContract, dbclean: :around_each do
