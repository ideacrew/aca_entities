...
RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipTraffickingVictimCategoryEligibilityBasisContract, dbclean: :after_each do

  # let(:required_params) { { status_code: "Complete" } }
