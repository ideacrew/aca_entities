...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/non_magi_eligibility_header_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::NonMagiEligibilityHeaderContract,  dbclean: :around_each do
