...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_eligibility_header_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiEligibilityHeaderContract,  dbclean: :around_each do
