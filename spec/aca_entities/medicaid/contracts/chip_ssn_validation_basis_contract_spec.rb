...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_ssn_validation_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipSsnValidationBasisContract,  dbclean: :around_each do
