...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_five_year_bar_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiFiveYearBarBasisContract,  dbclean: :around_each do
