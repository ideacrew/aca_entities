...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/verification_header_contract'

RSpec.describe AcaEntities::Medicaid::Contracts::VerificationHeaderContract, type: :model do
