...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/refugee_medical_assistance_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::RefugeeMedicalAssistanceBasisContract,  dbclean: :around_each do
