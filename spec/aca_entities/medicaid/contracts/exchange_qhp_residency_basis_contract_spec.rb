...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/exchange_qhp_residency_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ExchangeQhpResidencyBasisContract,  dbclean: :around_each do
