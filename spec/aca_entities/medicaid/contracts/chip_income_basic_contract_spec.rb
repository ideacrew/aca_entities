...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_income_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipIncomeBasisContract, dbclean: :around_each do
