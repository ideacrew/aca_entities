...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/insurance_premium_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::InsurancePremiumContract, dbclean: :after_each do
