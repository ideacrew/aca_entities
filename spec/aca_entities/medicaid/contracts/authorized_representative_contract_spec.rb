...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/authorized_representative_contract'

RSpec.describe AcaEntities::Medicaid::Contracts::AuthorizedRepresentativeContract, type: :model do
