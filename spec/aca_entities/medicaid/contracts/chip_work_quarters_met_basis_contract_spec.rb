...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_work_quarters_met_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipWorkQuartersMetBasisContract,  dbclean: :around_each do
