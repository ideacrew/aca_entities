...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_household_size_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipHouseholdSizeBasisContract,  dbclean: :around_each do
