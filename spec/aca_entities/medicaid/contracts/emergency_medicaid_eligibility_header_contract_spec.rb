...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/emergency_medicaid_eligibility_header_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::EmergencyMedicaidEligibilityHeaderContract,
