...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/csr_eligibility_header_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::CsrEligibilityHeaderContract,  dbclean: :around_each do
