...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_seven_year_limit_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiSevenYearLimitBasisContract, dbclean: :around_each do
