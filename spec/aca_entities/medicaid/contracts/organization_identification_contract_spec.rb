...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/organization_identification_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::OrganizationIdentificationContract, dbclean: :after_each do
