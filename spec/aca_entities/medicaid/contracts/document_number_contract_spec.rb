...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/document_number_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::DocumentNumberContract, dbclean: :after_each do
