...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/aptc_eligibility_header_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::AptcEligibilityHeaderContract,  dbclean: :around_each do
