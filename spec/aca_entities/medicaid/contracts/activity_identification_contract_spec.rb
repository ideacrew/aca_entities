...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/activity_identification_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ActivityIdentificationContract do
