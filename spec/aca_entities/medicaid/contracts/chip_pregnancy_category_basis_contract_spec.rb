...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_pregnancy_category_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipPregnancyCategoryBasisContract,  dbclean: :around_each do
