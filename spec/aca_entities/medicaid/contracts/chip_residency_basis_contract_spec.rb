...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_residency_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipResidencyBasisContract,  dbclean: :around_each do
