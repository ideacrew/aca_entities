...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_parent_caretaker_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiParentCaretakerBasisContract,  dbclean: :around_each do
