...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_chipra214_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiChipra214BasisContract,  dbclean: :around_each do
