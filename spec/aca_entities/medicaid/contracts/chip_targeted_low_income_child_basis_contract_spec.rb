...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_targeted_low_income_child_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipTargetedLowIncomeChildBasisContract,  dbclean: :around_each do
