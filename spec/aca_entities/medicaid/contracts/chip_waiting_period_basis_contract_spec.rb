...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_waiting_period_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipWaitingPeriodBasisContract,  dbclean: :around_each do
