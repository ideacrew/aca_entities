...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_eligibility_header_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipEligibilityHeaderContract,  dbclean: :around_each do
