...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_incarceration_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipIncarcerationBasisContract,  dbclean: :around_each do
