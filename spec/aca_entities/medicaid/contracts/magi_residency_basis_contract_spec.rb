...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_residency_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiResidencyBasisContract, dbclean: :around_each do
