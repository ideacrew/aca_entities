...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/exchange_verified_presence_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ExchangeVerifiedPresenceBasisContract,  dbclean: :around_each do
