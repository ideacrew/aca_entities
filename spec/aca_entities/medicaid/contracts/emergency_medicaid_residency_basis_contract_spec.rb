...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/emergency_medicaid_residency_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::EmergencyMedicaidResidencyBasisContract,  dbclean: :around_each do
