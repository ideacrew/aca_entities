...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_state_health_benefits_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipStateHealthBenefitsBasisContract,  dbclean: :around_each do
