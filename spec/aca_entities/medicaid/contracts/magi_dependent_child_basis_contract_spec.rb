...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_dependent_child_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiDependentChildBasisContract, dbclean: :around_each do
