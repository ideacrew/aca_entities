...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/exchange_incarceration_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ExchangeIncarcerationBasisContract,  dbclean: :around_each do
