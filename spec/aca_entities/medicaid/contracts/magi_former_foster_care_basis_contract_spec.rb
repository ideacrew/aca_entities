...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_former_foster_care_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiFormerFosterCareBasisContract,  dbclean: :around_each do
