...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_targeted_low_income_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiTargetedLowIncomeBasisContract, dbclean: :around_each do
