...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/magi_adult_group_xx_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::MagiAdultGroupXxBasisContract,  dbclean: :around_each do
