...
require 'spec_helper'
require 'aca_entities/medicaid/contracts/chip_citizenship_and_immigration_basis_contract'

RSpec.describe ::AcaEntities::Medicaid::Contracts::ChipCitizenshipAndImmigrationBasisContract,
