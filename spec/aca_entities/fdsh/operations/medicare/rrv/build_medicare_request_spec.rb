...
RSpec.describe AcaEntities::Fdsh::Rrv::Medicare::Operations::BuildMedicareRequest do
  ...
  context "when ssn does not match" do
    subject do
      described_class.new.call({ applications: [application], transaction_encrypted_ssn: nil })
    end
    ...
    it "should return only one applicant" do
      expect(subject.success.to_hash[:IndividualRequests].count).to eq 0
    end
  end
end
