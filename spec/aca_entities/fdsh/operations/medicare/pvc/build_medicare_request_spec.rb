...
RSpec.describe AcaEntities::Fdsh::Pvc::Medicare::Operations::BuildMedicareRequest, dbclean: :after_each do
  ...
  it 'should return a AcaEntities::Fdsh::Pvc::Medicare::EesDshBatchRequestData entity' do
    expect(subject.value!).to be_a(AcaEntities::Fdsh::Pvc::Medicare::EesDshBatchRequestData)
  end
end