...
RSpec.describe ::AcaEntities::Fdsh::Ridp::Rj139::Operations::PersonToPrimaryRequest, dbclean: :after_each do
  ...
  describe 'with valid arguments' do
    ...
    context 'with valid demographics' do
      ...
      it 'should have a preferred language code of spa' do
        expect(@json_result["ridpRequest"]["primaryRequest"]["person"]["personPreferredLanguage"]).to eq 'spa'
      end

      it 'should not include the blank suffix' do
        expect(@json_result["ridpRequest"]["primaryRequest"]["person"].keys).not_to include "personSuffixName"
      end
