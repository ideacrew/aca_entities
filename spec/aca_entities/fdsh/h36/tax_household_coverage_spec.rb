...
RSpec.describe AcaEntities::Fdsh::H36::TaxHouseholdCoverage, dbclean: :after_each do
  include_context('irs_group_coverage_shared_context')

  subject { described_class.new }

  let(:required_params) do
    tax_household_coverage
  end
    ...
    it 'should raise error' do
      expect do
        described_class.new(required_params.reject do |k, _v|
          k == :ApplicableCoverageMonthNum
        end)
      end.to raise_error(Dry::Struct::Error, /:ApplicableCoverageMonthNum is missing/)
    end
  end
end
