...
RSpec.describe AcaEntities::Fdsh::H36::InsurancePolicy, dbclean: :after_each do
    ...
    it 'should raise error' do
      expect do
        described_class.new(required_params.reject do |k, _v|
          k == :InsuranceCoverages
        end)
      end.to raise_error(Dry::Struct::Error, /:InsuranceCoverages is missing/)
    end
  end
end
