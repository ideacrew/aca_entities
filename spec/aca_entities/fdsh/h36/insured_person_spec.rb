...
RSpec.describe AcaEntities::Fdsh::H36::InsuredPerson, dbclean: :after_each do
    ...
    it 'should raise error' do
      expect do
        described_class.new(required_params.reject do |k, _v|
          k == :CompletePersonName
        end)
      end.to raise_error(Dry::Struct::Error, /:CompletePersonName is missing/)
    end
  end
end
