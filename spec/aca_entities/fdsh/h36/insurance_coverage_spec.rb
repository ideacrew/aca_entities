...
RSpec.describe AcaEntities::Fdsh::H36::InsuranceCoverage, dbclean: :after_each do
    ...
    it 'should raise error' do
      expect do
        described_class.new(required_params.reject do |k, _v|
          k == :TotalQHPMonthlyPremiumAmt
        end)
      end.to raise_error(Dry::Struct::Error, /:TotalQHPMonthlyPremiumAmt is missing/)
    end
  end
end
