...
RSpec.describe AcaEntities::Fdsh::H36::Contracts::IrsHouseholdGroupContract, dbclean: :after_each do
  ...
  let(:error_messages) do
    {
      IrsGroupIdentificationNumber: ['is missing'],
      TaxHouseholds: ['is missing'],
      InsurancePolicies: ['is missing']
    }
  end
