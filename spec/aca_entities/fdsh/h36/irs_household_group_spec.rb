...
RSpec.describe AcaEntities::Fdsh::H36::IrsHouseholdGroup, dbclean: :after_each do
    ...
    it 'should raise error' do
      expect do
        described_class.new(required_params.reject do |k, _v|
          k == :IrsGroupIdentificationNumber
        end)
      end.to raise_error(Dry::Struct::Error, /:IrsGroupIdentificationNumber is missing/)
    end
  end
end
