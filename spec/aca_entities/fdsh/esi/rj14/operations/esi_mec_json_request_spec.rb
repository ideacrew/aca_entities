...
RSpec.describe AcaEntities::Fdsh::Esi::Rj14::Operations::EsiMecJsonRequest, dbclean: :after_each do
  ...
  context "when no applicants on the application have esi_evidence" do
    let(:esi_evidence) { nil }
