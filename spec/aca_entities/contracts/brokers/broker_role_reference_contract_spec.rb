...
RSpec.describe ::AcaEntities::Contracts::Brokers::BrokerRoleReferenceContract, dbclean: :after_each do
  ...
  context 'failure case' do
    ...
    context 'with bad input data type' do
      before do
        @result = subject.call(required_params.merge(person_reference: nil))
      end
      ...
      it 'should return error message' do
        result = subject.call(required_params.merge(npn: Date.today))
