...
require 'aca_entities/contracts/pregnancy_information_contract'
...
require 'aca_entities/contracts/household_member_contract'

RSpec.describe AcaEntities::Contracts::HouseholdMemberContract, type: :model, dbclean: :after_each do
