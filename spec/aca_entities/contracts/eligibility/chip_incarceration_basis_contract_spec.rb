...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_incarceration_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipIncarcerationBasisContract,  dbclean: :around_each do
