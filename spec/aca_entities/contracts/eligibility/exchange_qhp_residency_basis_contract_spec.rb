...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/exchange_qhp_residency_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ExchangeQhpResidencyBasisContract,  dbclean: :around_each do
