...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_former_foster_care_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiFormerFosterCareBasisContract,  dbclean: :around_each do
