...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_ssn_validation_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipSsnValidationBasisContract,  dbclean: :around_each do
