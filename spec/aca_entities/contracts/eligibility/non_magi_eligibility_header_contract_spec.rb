...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/non_magi_eligibility_header_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::NonMagiEligibilityHeaderContract,  dbclean: :around_each do
