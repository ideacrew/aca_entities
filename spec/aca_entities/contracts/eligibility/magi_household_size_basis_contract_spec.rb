...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_household_size_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiHouseholdSizeBasisContract,  dbclean: :around_each do
