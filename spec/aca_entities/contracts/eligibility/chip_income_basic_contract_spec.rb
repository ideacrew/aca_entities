...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_income_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipIncomeBasisContract, dbclean: :around_each do
