...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_targeted_low_income_child_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipTargetedLowIncomeChildBasisContract,  dbclean: :around_each do
