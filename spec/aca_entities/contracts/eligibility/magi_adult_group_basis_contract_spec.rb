...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_adult_group_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiAdultGroupBasisContract,  dbclean: :around_each do
