...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_adult_group_xx_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiAdultGroupXxBasisContract,  dbclean: :around_each do
