...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/exchange_verified_presence_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ExchangeVerifiedPresenceBasisContract,  dbclean: :around_each do
