...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/aptc_eligibility_header_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::AptcEligibilityHeaderContract,  dbclean: :around_each do
