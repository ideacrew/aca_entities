...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/emergency_medicaid_residency_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::EmergencyMedicaidResidencyBasisContract,  dbclean: :around_each do
