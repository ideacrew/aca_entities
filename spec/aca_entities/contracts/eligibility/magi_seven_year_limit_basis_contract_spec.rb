...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_seven_year_limit_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiSevenYearLimitBasisContract, dbclean: :around_each do
