...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/csr_eligibility_header_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::CsrEligibilityHeaderContract,  dbclean: :around_each do
