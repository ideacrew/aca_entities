...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_five_year_bar_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiFiveYearBarBasisContract,  dbclean: :around_each do
