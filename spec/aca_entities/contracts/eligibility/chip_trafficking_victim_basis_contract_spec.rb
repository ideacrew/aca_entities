...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_trafficking_victim_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipTraffickingVictimBasisContract,  dbclean: :around_each do
