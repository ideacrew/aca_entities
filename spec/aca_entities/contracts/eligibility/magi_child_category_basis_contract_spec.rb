...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_child_category_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiChildCategoryBasisContract,  dbclean: :around_each do
