...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/exchange_incarceration_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ExchangeIncarcerationBasisContract,  dbclean: :around_each do
