...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/non_magi_eligibility_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::NonMagiEligibilityBasisContract, dbclean: :around_each do
