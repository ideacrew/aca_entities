...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_residency_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiResidencyBasisContract, dbclean: :around_each do
  ...
  let(:all_params) do
    required_params.merge(
      ...
      pend_reason: "pend reason",
      student_residency_rule_applies: true,
      medicaid_correct_state: false
    )
  end
