...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_eligibility_header_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipEligibilityHeaderContract,  dbclean: :around_each do
