...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_ssn_validation_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiSsnValidationBasisContract, dbclean: :around_each do
