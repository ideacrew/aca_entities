...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/refugee_medical_assistance_eligibility_header_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::RefugeeMedicalAssistanceEligibilityHeaderContract,
