...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/refugee_medical_assistance_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::RefugeeMedicalAssistanceBasisContract,  dbclean: :around_each do
