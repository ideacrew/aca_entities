...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_chipra214_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiChipra214BasisContract,  dbclean: :around_each do
