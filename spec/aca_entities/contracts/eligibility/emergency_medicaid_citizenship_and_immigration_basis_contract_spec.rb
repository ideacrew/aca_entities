...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/emergency_medicaid_citizenship_and_immigration_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::EmergencyMedicaidCitizenshipAndImmigrationBasisContract,
