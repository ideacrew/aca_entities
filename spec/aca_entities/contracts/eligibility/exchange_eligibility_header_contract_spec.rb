...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/exchange_eligibility_header_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ExchangeEligibilityHeaderContract,  dbclean: :around_each do
