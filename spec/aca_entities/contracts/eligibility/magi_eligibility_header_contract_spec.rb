...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_eligibility_header_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiEligibilityHeaderContract,  dbclean: :around_each do
