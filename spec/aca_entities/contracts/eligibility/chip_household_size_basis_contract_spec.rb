...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_household_size_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipHouseholdSizeBasisContract,  dbclean: :around_each do
