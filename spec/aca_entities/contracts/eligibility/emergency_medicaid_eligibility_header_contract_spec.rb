...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/emergency_medicaid_eligibility_header_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::EmergencyMedicaidEligibilityHeaderContract,
  ...
  let(:all_params) do
    required_params.merge(
      eligibility_status_indicator: true,
