...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/emergency_medicaid_income_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::EmergencyMedicaidIncomeBasisContract,  dbclean: :around_each do
