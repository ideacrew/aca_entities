...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_citizenship_and_immigration_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipCitizenshipAndImmigrationBasisContract,
