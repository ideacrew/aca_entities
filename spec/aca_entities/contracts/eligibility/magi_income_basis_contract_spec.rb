...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_income_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiIncomeBasisContract,  dbclean: :around_each do
