...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_work_quarters_met_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipWorkQuartersMetBasisContract,  dbclean: :around_each do
