...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_parent_caretaker_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiParentCaretakerBasisContract,  dbclean: :around_each do
