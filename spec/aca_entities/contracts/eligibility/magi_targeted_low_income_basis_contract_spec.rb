...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/magi_targeted_low_income_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::MagiTargetedLowIncomeBasisContract, dbclean: :around_each do
