...
require 'spec_helper'
require 'aca_entities/contracts/eligibility/chip_residency_basis_contract'

RSpec.describe ::AcaEntities::Contracts::Eligibility::ChipResidencyBasisContract,  dbclean: :around_each do
