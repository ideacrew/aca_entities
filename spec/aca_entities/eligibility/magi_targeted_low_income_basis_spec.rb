...
require 'spec_helper'
require 'aca_entities/eligibility/magi_targeted_low_income_basis'

RSpec.describe ::AcaEntities::Eligibility::MagiTargetedLowIncomeBasis, dbclean: :around_each do
