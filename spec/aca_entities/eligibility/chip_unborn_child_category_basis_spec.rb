...
require 'spec_helper'
require 'aca_entities/eligibility/chip_unborn_child_category_basis'

RSpec.describe ::AcaEntities::Eligibility::ChipUnbornChildCategoryBasis,  dbclean: :around_each do
