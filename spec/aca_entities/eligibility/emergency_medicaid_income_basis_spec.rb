...
require 'spec_helper'
require 'aca_entities/eligibility/emergency_medicaid_income_basis'

RSpec.describe ::AcaEntities::Eligibility::EmergencyMedicaidIncomeBasis,  dbclean: :around_each do
