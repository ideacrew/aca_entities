...
require 'spec_helper'
require 'aca_entities/eligibility/refugee_medical_assistance_eligibility_header'

RSpec.describe ::AcaEntities::Eligibility::RefugeeMedicalAssistanceEligibilityHeader,
