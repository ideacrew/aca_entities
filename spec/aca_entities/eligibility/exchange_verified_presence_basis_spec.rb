...
require 'spec_helper'
require 'aca_entities/eligibility/exchange_verified_presence_basis'

RSpec.describe ::AcaEntities::Eligibility::ExchangeVerifiedPresenceBasis,  dbclean: :around_each do
