...
require 'spec_helper'
require 'aca_entities/eligibility/emergency_medicaid_residency_basis'

RSpec.describe ::AcaEntities::Eligibility::EmergencyMedicaidResidencyBasis,  dbclean: :around_each do
