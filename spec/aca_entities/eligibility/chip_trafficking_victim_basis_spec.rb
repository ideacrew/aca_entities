...
require 'spec_helper'
require 'aca_entities/eligibility/chip_trafficking_victim_basis'

RSpec.describe ::AcaEntities::Eligibility::ChipTraffickingVictimBasis,  dbclean: :around_each do
