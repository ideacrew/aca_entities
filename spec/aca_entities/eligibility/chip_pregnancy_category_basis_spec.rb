...
require 'spec_helper'
require 'aca_entities/eligibility/chip_pregnancy_category_basis'

RSpec.describe ::AcaEntities::Eligibility::ChipPregnancyCategoryBasis,  dbclean: :around_each do
