...
RSpec.describe ::AcaEntities::Households::Household, dbclean: :after_each do
    ...
    it 'should raise error' do
      expect do
        described_class.new(input_params.reject do |k, _v|
                              k == :coverage_households
                            end)
      end.to raise_error(Dry::Struct::Error, /:coverage_households is missing/)
    end
  end
end
