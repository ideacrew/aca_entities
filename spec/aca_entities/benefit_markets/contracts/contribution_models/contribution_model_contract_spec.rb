...
RSpec.describe AcaEntities::BenefitMarkets::ContributionModels::ContributionModelContract do
  ...
  let(:member_relationship_map_params)        { { relationship_name: :Employee, count: 1, operator: :>= } }
  let(:member_relationship_map)               { AcaEntities::BenefitMarkets::MemberRelationshipMap.new(member_relationship_map_params).to_h }
  ...
  let(:member_relationship) do
    AcaEntities::BenefitMarkets::MemberRelationship.new(
  ...
  let(:member_relationships)                  { [member_relationship.to_h] }
