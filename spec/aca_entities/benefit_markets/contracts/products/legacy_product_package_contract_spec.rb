...
RSpec.describe AcaEntities::BenefitMarkets::Products::LegacyProductPackageContract do
  ...
  let(:rating_area_params) do
    {
      county_zip_ids: [{}], exchange_provided_code: 'code', covered_states: [{}], active_year: 2020
    }
  end
