...
RSpec.describe AcaEntities::Serializers::Xml::Fdsh::Ridp::SecondaryResponse do

  let(:file) do
    loc = File.join(File.dirname(__FILE__), "..", "..", "..", "..", "..", "reference", "xml", "ridp", "RIDPSecondaryResponse.xml")
