...
RSpec.describe AcaEntities::Cms::Pbp::Contracts::FinancialInformationContract, dbclean: :after_each do
  ...
  context 'failure case' do
    context 'missing required param' do
      before do
        @result = subject.call(required_params.reject { |k, _v| k == :financial_effective_start_date })
      end
    ...
    context 'with bad input data type' do
      before do
        @result = subject.call(required_params.merge(financial_effective_start_date: nil))
      end
