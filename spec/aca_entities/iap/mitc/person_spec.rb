...
require 'aca_entities/iap/mitc/income'
require 'aca_entities/iap/mitc/relationship'
require 'aca_entities/iap/mitc/person'

RSpec.describe ::AcaEntities::Iap::Mitc::Person do
  describe 'with valid arguments' do
    ...
    it 'should initialize' do
      expect(described_class.new(input_params)).to be_a ::AcaEntities::Iap::Mitc::Person
    end
