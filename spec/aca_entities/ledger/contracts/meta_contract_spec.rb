...
RSpec.describe AcaEntities::Ledger::Contracts::MetaContract do
  ...
  context 'Calling the contract with no params' do
    let(:error_message) { { transaction_header: ['is missing'] } }
    it 'should pass validation' do
      result = subject.call({})
