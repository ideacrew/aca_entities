...
RSpec.describe AcaEntities::Ledger::Contracts::CustomerAccountContract do
  ...
  context 'CustomerAccount components' do
    ...
    let(:required_params) do
      { customer: customer, customer_role: customer_role, policies: policies, is_active: is_active }
    end
    let(:optional_params) { { id: id, tax_households: tax_households, account: account, timestamps: timestamps } }
    ...
    context 'Calling the contract with no params' do
      let(:error_message) do
        { customer: ['is missing'], is_active: ['is missing'], customer_role: ['is missing'], policies: ['is missing'] }
      end
      it 'should pass validation' do
        result = subject.call({})
  ...
  context 'CustomerAccount transaction' do
    let(:transaction) do
      {
        customer: {
