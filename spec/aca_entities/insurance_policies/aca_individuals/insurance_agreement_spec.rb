...
RSpec.describe ::AcaEntities::InsurancePolicies::AcaIndividuals::InsuranceAgreement, dbclean: :after_each do
  ...
  let(:insurance_agreement_params) do
    AcaEntities::InsurancePolicies::AcaIndividuals::Contracts::InsuranceAgreementContract.new.call(input_params)
  end

  describe 'with valid arguments' do
    it 'validates input params with contract' do
      expect(insurance_agreement_params.success?).to be_truthy
    end

    it 'should initialize' do
      expect(described_class.new(insurance_agreement_params.to_h)).to be_a described_class
    end

    it 'should not raise error' do
      expect { described_class.new(insurance_agreement_params.to_h) }.not_to raise_error
    end
  end
end