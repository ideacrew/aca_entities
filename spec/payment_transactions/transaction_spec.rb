...
require "../aca_entities/lib/aca_entities/payment_transactions/transaction.rb"
  ...
  describe "Transaction Entity" do
    ...
    context 'Passing valid params' do
      it 'should initialize' do
        expect(::AcaEntities::PaymentTransactions::Transaction.new(input_params)).to be_a ::AcaEntities::PaymentTransactions::Transaction
      end
